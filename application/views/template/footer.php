		...
		<div class="modal-content">
			...
			<div class="modal-body text-center">
				<?php if ($this->workUpdate == '1') { ?>
					<a href="<?= base_url('company-select?accinfo=3') ?>" class="btn btn-primary w-100 mb-2">Work Update
					</a>
				<?php
				}
				?>
				<?php if ($this->QC == '1') { ?>
					<a href="<?= base_url('company-select?accinfo=5') ?>" class="btn btn-primary w-100">QC Update
					</a>
				<?php
				}
				?>
