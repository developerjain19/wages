                                ...
                                <div class="basic-form">
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class=" col-sm-10">
                                                <input type=" text" class="form-control" name="number" placeholder="Enter your contact number" value="<?= (($tag == 'edit') ? $labour[0]['number'] : '')  ?>">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="address" placeholder="Enter your address" value="<?= (($tag == 'edit') ? $labour[0]['address'] : '')  ?>">
                                            </div>
                                        </div>
